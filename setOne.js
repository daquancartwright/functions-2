...
const printParams = (parameter1, parameter2) => console.log(`The first parameter is ${parameter1}. The second parameter is ${parameter2}]`)


// INVOKE THE FUNCTION HERE. THE PARAMETERS TAKE ANY DATATYPE.

console.log(`\nProblem 2:`)
printParams('Hello', 'DaQuan')
...
greeting('DaQuan', 'Cartwright', (fullName) =>
...
// CODE HERE
function multiplyingFactory(n1) {
    return (n2) => {
        if(n1 >= 5) {
            console.log(n1 * n2)
        } else {
